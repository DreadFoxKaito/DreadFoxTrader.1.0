#!/usr/bin/env python3
"""
Dreadfox.Superhexagon.Robinhood.py (Web-App Compatible)
...
- Trailing-stop sell for indicator-driven sells (2x ATR)
...
def should_buy(
    ...
    *,
    ...
    """
    Determines whether the conditions to buy a stock are met.

    Preserves:
    - MA/RSI buy logic
    - New check: ticker holdings must not exceed 1/portfolio_cap_divisor of total portfolio,
      where divisor includes the cash slice (min 2).
    """
...
def main() -> int:
    ...
    def write_status(payload: Dict[str, Any]) -> None:
        ...
        payload["ts"] = iso_now()
        payload["script"] = "Superhexagon.Robinhood"
